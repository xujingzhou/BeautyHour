...
- (UIView *) mkContentView
{
    ...
    for (KxMenuItem *menuItem in _menuItems)
    {
        ...
        if (menuItem.title.length)
        {
            ...
            FXLabel *titleLabel = [[FXLabel alloc] initWithFrame:titleFrame];
            ...
            switch (itemNum)
            {
                ...
                case 4:
                {
                    ...
                    titleLabel.gradientEndColor = [UIColor whiteColor];
...
- (CGPoint) arrowPoint
{
    ...
    if (_arrowDirection == KxMenuViewArrowDirectionUp)
    {
        point = (CGPoint)
        {
            CGRectGetMinX(self.frame) + _arrowPosition, CGRectGetMinY(self.frame)
        };
    }
    else if (_arrowDirection == KxMenuViewArrowDirectionDown)
    {
        point = (CGPoint)
        {
            CGRectGetMinX(self.frame) + _arrowPosition, CGRectGetMaxY(self.frame)
        };
    }
    else if (_arrowDirection == KxMenuViewArrowDirectionLeft)
    {
        point = (CGPoint)
        {
            CGRectGetMinX(self.frame), CGRectGetMinY(self.frame) + _arrowPosition
        };
    }
    else if (_arrowDirection == KxMenuViewArrowDirectionRight)
    {
        point = (CGPoint)
        {
            CGRectGetMaxX(self.frame), CGRectGetMinY(self.frame) + _arrowPosition
        };
    }
    else
    {
